...
data class Authorization @JsonCreator constructor(
        @JsonProperty(ACL_OBJECT_PATH) val aclKey: AclKey,
        @JsonProperty(PERMISSIONS) val permissions: Map<Permission, Boolean>
) {
